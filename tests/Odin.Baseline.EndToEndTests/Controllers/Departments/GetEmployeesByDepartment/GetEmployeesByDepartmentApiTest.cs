...
namespace Odin.Baseline.EndToEndTests.Controllers.Departments.GetEmployeesByDepartment
{
    ...
    public class GetEmployeesByDepartmentApiTest
    {
        ...
        {
            var departmentsList = _fixture.GetValidDepartmentsModelList(length: 2);
            var departmentsIds = departmentsList.Select(x => x.Id).ToList();

            var employeesList = _fixture.GetValidEmployeesModelList(departmentsIds, length: 8);
        ...
        public async Task ListPaginated(int quantityToGenerate, int page, int pageSize, int expectedItems)
        {
            ...
            var employeesList = _fixture.GetValidEmployeesModelList(departmentsIds, length: quantityToGenerate);
        ...
        public async Task SearchByName(string search, int page, int pageSize, int expectedQuantityItemsReturned, int expectedQuantityTotalItems)
        {
            ...
            {
                new EmployeeModel(Guid.NewGuid(), "Employee 01", "Test",  _fixture.GetValidEmployeeDocument(), _fixture.GetValidEmployeeEmail(), true,  DateTime.Now, "unit.Testing", DateTime.Now, "unit.testing", _fixture.TenantSinapseId, department.Id),
                new EmployeeModel(Guid.NewGuid(), "Employee 02", "Test",  _fixture.GetValidEmployeeDocument(), _fixture.GetValidEmployeeEmail(), true,  DateTime.Now, "unit.Testing", DateTime.Now, "unit.testing", _fixture.TenantSinapseId, department.Id),
                new EmployeeModel(Guid.NewGuid(), "Employee 03", "Test",  _fixture.GetValidEmployeeDocument(), _fixture.GetValidEmployeeEmail(), true,  DateTime.Now, "unit.Testing", DateTime.Now, "unit.testing", _fixture.TenantSinapseId, department.Id),
                new EmployeeModel(Guid.NewGuid(), "Employee 04", "Test",  _fixture.GetValidEmployeeDocument(), _fixture.GetValidEmployeeEmail(), false, DateTime.Now, "unit.Testing", DateTime.Now, "unit.testing", _fixture.TenantSinapseId, department.Id),
                new EmployeeModel(Guid.NewGuid(), "Employee 05", "Test",  _fixture.GetValidEmployeeDocument(), _fixture.GetValidEmployeeEmail(), false, DateTime.Now, "unit.Testing", DateTime.Now, "unit.testing", _fixture.TenantSinapseId, department.Id),
                new EmployeeModel(Guid.NewGuid(), "Depto 01",    "Test",  _fixture.GetValidEmployeeDocument(), _fixture.GetValidEmployeeEmail(), true,  DateTime.Now, "unit.Testing", DateTime.Now, "unit.testing", _fixture.TenantSinapseId, department.Id),
                new EmployeeModel(Guid.NewGuid(), "Depto 02",    "Test",  _fixture.GetValidEmployeeDocument(), _fixture.GetValidEmployeeEmail(), true,  DateTime.Now, "unit.Testing", DateTime.Now, "unit.testing", _fixture.TenantSinapseId, department.Id),
                new EmployeeModel(Guid.NewGuid(), "Depto 03",    "Test",  _fixture.GetValidEmployeeDocument(), _fixture.GetValidEmployeeEmail(), false, DateTime.Now, "unit.Testing", DateTime.Now, "unit.testing", _fixture.TenantSinapseId, department.Id)
            };
