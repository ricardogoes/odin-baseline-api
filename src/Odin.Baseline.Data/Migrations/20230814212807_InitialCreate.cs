        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    document = table.Column<string>(type: "character varying(255)", maxLength: 255, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_companies_positions", x => x.position_id);
                    table.ForeignKey(
                        name: "FK_companies_positions_customers_customer_id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_employees_companies_positions_position_id",
                        column: x => x.position_id,
                        principalTable: "companies_positions",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_companies_positions_customer_id",
