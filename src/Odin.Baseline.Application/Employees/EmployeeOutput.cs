...
namespace Odin.Baseline.Application.Employees
{
    public class EmployeeOutput
    {
        ...
        public EmployeeOutput(Guid id, string firstName, string lastName, string document, string email,
            ...
            Address? address = null, IReadOnlyList<EmployeePositionHistory>? positionsHistory = null, DepartmentData? department = null)
        {
            Id = id;
            FirstName = firstName;
            LastName = lastName;
